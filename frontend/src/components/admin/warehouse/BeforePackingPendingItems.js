...
const BeforePackingPendingItems = () => {
    ...
    const fetchItems = useCallback(async () => {
        ...
        try {
            ...
            setError('Failed to fetch Before Packing pending items.');
        } finally {
            setLoading(false);
        }
    }, []);
    ...
    if (loading) return (
        <div className="p-4 flex flex-col items-center justify-center">
            ...
            <div className="text-red-500 font-medium">Loading Pending Items...</div>
        </div>
    );
...
export default BeforePackingPendingItems;