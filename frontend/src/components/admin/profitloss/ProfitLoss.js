      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <div className="bg-green-50 rounded-lg p-4 text-center">
            <LuDollarSign className="h-8 w-8 text-green-600 mx-auto mb-2" />
            <p className="text-sm text-green-600 font-medium">Shop Revenue</p>
            <p className="text-2xl font-bold text-green-800">{formatCurrency(consolidated.shopRevenue)}</p>
          </div>
          <div className="bg-orange-50 rounded-lg p-4 text-center">
            <LuDollarSign className="h-8 w-8 text-orange-600 mx-auto mb-2" />
            <p className="text-sm text-orange-600 font-medium">Admin Revenue</p>
            <p className="text-2xl font-bold text-orange-800">{formatCurrency(consolidated.adminRevenue)}</p>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
          ...
          <div className="bg-orange-50 rounded-lg p-3">
            <p className="text-sm text-orange-600">Admin Revenue %</p>
            <p className="text-lg font-bold text-orange-800">
              {consolidated.totalRevenue > 0 ? 
                ((consolidated.adminRevenue / consolidated.totalRevenue) * 100).toFixed(1) : '0.0'}%
            </p>
          </div>
        </div>
      </div>
