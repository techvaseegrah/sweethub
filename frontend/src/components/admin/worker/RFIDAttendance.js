...
const RFID_ATTENDANCE_URL = '/admin/attendance/rfid-attendance';
    ...
    <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md">
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl max-w-md w-full">
            <h3 className="text-lg sm:text-xl font-semibold mb-4">Confirm RFID Submission</h3>
            <p className="mb-4 text-sm sm:text-base">Are you sure you want to submit this RFID for attendance?</p>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="list-disc pl-5 space-y-1 text-gray-700 text-sm">
          <li>Scan or enter the worker's RFID card</li>
          <li>Click "Submit" to record attendance</li>
          <li>Confirm the RFID value in the popup</li>
          <li>The system will automatically determine if it's a check-in or check-out</li>
          <li>If a worker missed an out-punch from the previous day, the system will automatically correct it</li>
          <li>View the confirmation message to verify the action</li>
          <li>RFID input will automatically clear after 3 seconds for the next worker</li>
        </ul>
      </div>
    </div>
  );
