    ...
    <div className={`h-screen w-64 ${sidebarBg} ${textPrimary} flex flex-col border-r ${borderColor} overflow-hidden shadow-sm relative`}>
      ...
      <nav className="flex-1 px-4 py-6 space-y-2 relative z-10 overflow-y-auto">
        ...
        <details className="group">
          <summary className={`flex items-center justify-between px-3 py-2.5 rounded-lg cursor-pointer transition-all duration-200 ${hoverBg} ${textPrimary} list-none`}>
           ...
           <nav className="mt-1 ml-6 space-y-1">
             <NavLink to="/shop/workers/add" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
                <span className="font-medium">Add Worker</span>
              </NavLink>
              <NavLink to="/shop/workers/view" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
                <span className="font-medium">View Workers</span>
              </NavLink>
              <NavLink to="/shop/workers/attendance" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
                <span className="font-medium">Attendance Tracking</span>
              </NavLink>
              <NavLink to="/shop/workers/salary-report" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
                <span className="font-medium">Salary Report</span>
              </NavLink>
              <NavLink to="/shop/workers/holidays" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
        ...
        <details className="group">
          ...
          <nav className="mt-1 ml-6 space-y-1">
             <NavLink to="/shop/departments/create" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
                <span className="font-medium">Create Department</span>
              </NavLink>
              <NavLink to="/shop/departments/view" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
        ...
        <details className="group" open={isProductMenuOpen} onToggle={toggleProductMenu}>
          ...
          <nav className="mt-1 ml-6 space-y-1">
            <NavLink to="/shop/products/view" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}` }`}>
              <span className="font-medium">View Products</span>
            </NavLink>
            <NavLink to="/shop/warehouse/stock" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}` }`}>
              <span className="font-medium">Track Stock</span>
            </NavLink>
            <NavLink to="/shop/warehouse/alerts" className={({ isActive }) => `flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}` }`}>
        ...
        <details className="group">
          ...
          <nav className="mt-1 ml-6 space-y-1">
            <NavLink to="/shop/billing/create" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
              <span className="font-medium">Create Bill</span>
            </NavLink>
            <NavLink to="/shop/billing/view" className={({ isActive }) => `flex items-center px-3 py-2 text-sm rounded-lg transition-all duration-200 ${ isActive ? activeRed : `${textSecondary} ${hoverBg}`}`}>
